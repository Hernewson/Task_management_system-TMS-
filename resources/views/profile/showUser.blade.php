                ...
                <div class="container">
                    <div class="row my-2">
                            ...
                            <div class="tab-content py-4">
                                <div class="tab-pane active" id="profile">
                                    <h2 class="mb-3">{{Auth::user()->name}}<span
                                            style="font-size:17px;">({{Auth::user()->name}})</span></h2>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4><i class="fa fa-envelope"></i>&nbsp; :
                                                <span>{{Auth::user()->email}}</span></h4>
                                            <h4><i class="fa fa-phone"></i>&nbsp;&nbsp; :
                                                <span>{{Auth::user()->phone}}</span></h4>
                        ...
                        <div class="col-lg-4 order-lg-1 text-center">
                            <img src="https://f0.pngfuel.com/png/980/304/man-profile-illustration-computer-icons-user-profile-avatar-png-clip-art-thumbnail.png"
