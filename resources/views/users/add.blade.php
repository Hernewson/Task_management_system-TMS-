                                    ...
                                    @csrf
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" placeholder="Enter name" name="name" data-validation="length"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="email"
                                                    placeholder="Enter email address" data-validation="email" name="email" autocomplete="email">
                                            </div>
