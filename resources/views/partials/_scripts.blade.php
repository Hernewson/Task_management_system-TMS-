...
<script src="http://radixtouch.in/templates/admin/smart/source/assets/js/pages/sparkline/sparkline-data.js')}}">
</script>
<!-- Common js-->
...
<script src="{{asset('assets/js/front_js/global.js')}}"></script>
<script src="{{asset('assets/js/front_js/jquery-ui.min.js')}}"></script>
