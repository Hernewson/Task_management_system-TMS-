					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item start active open">
								<a href="pages/index" class="nav-link nav-toggle">
							...
							<li class="nav-item">
								<a href="index.html#" class="nav-link nav-toggle"><i class="material-icons">group</i>
							...
							<li class="nav-item">
								<a href="index.html#" class="nav-link nav-toggle"> <i class="material-icons">school</i>
							...
							<li class="nav-item">
								<a href="index.html#" class="nav-link nav-toggle"> <i class="material-icons">local_library</i>
							...
							<li class="nav-item">
								<a href="index.html#" class="nav-link nav-toggle"> <i class="material-icons">business</i>
							...
							<li class="nav-item">
								<a href="index.html#" class="nav-link nav-toggle"> <i class="material-icons">face</i>
							...
							<li class="nav-item">
								<a href="index.html#" class="nav-link nav-toggle"> <i
